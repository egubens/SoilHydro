...
---
[![Live app](https://img.shields.io/badge/Live%20app-SoilHydro-blue)](https://3n0c6z-erick-gutierrez.shinyapps.io/SoilHydro/)
...
You can use all **SoilHydro** functions in your browser—no installation needed:

👉 [SoilHydro Web App](https://3n0c6z-erick-gutierrez.shinyapps.io/SoilHydro/)

The app mirrors the package workflow (fitting, prediction, water points, and pore-size plots).
